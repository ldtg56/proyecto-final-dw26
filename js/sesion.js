        ...
        try {
            ...
            if (datos.logueado) {
                menuUsuario.innerHTML = `
                    ...
                    <li><a class="dropdown-item" href="usuario_dashboard_pedidos.html">Historial de Compras</a></li>
                    <li><a class="dropdown-item" href="usuario_dashboard_cupones.html">Mis Cupones</a></li>
